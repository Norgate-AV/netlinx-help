...
!!! note
    ...
    the [DEFINE_CALL](DEFINE_CALL.md) keyword. [DEFINE_FUNCTION](DEFINE_FUNCTION.md) differs from
    [DEFINE_CALL](DEFINE_CALL.md) by allowing values to be returned using the [RETURN](RETURN.md) statement.

-   [CALL](CALL.md)
-   [DEFINE_CALL](DEFINE_CALL.md)
-   [DEFINE_FUNCTION](DEFINE_FUNCTION.md)
-   [RETURN](RETURN.md)
-   [SYSTEM_CALL](SYSTEM_CALL.md)
