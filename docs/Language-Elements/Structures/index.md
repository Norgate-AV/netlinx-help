...
!!! note
    ...
    A structure is declared in the [DEFINE_TYPE](DEFINE_TYPE.md) section of the program.

Once declared, a structure may be used in the same way as any other data type. Here is a syntax
sample:
...
Structures can be initialized using set notation as in the two examples below. Notice that the
members of each structure as well as the entire array are enclosed in braces.
...
!!! note
    ...
    <!-- markdownlint-disable-line -->
    The attributes [VOLATILE](VOLATILE.md), [PERSISTENT](PERSISTENT.md), and
