---
title: "#DISABLE_WARNING"
---

# \#DISABLE_WARNING

This [Compiler Directive](Compiler_Directives.md) disables a specified warning message from being
...
!!! note
    ...
    Do not include the “C” prefix from the warning message.
