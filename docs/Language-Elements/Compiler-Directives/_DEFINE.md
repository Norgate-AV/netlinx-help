...
This [Compiler Directive](Compiler_Directives.md) defines a symbol to be used only by
[\#IF_DEFINED](_IF_DEFINED.md) and [\#IF_NOT_DEFINED](_IF_NOT_DEFINED.md) directives.
...
-   The symbol can be defined anywhere in the program file but cannot be used in any statement that
