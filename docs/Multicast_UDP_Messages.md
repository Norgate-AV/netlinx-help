...
To send a multi-cast UDP message, specify a multi-cast address and port in the [IP_CLIENT_OPEN](IP_CLIENT_OPEN.md) function such as the following:

IP_CLIENT_OPEN (dvIPClient.Port,'239.255.255.250',1900,IP_UDP)

To receive multi-cast UDP messages, you must call the [IP_MC_SERVER_OPEN](IP_MC_SERVER_OPEN.md) function:
