...
[IP_MC_SERVER_OPEN](IP_MC_SERVER_OPEN.md) function:

IP_MC_SERVER_OPEN ( dvIPServer,'239.255.255.250',1900)

The NetLinx master will join the multi-cast session and allow you to receive and
transmit UDP multi-cast messages.
