...
Note: Even if you do not include any code in mainline (the DEFINE_PROGRAM section), feedback statements from button event handlers are still run as part of mainline.
...
![image\Message_and_Mainline_processing.gif](image/Message_and_Mainline_processing.gif "image\Message_and_Mainline_processing.gif")
