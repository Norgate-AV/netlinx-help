...
A _statement_ refers to a complete programming instruction such as:
...
_Expressions_, on the other hand, are sub-components of statements.
...
!!! note
    ...
    It is also strongly recommended that semicolons be used to terminate each statement (as in the C
    language).
