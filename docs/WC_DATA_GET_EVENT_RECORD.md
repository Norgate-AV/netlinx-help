...
The \_WC_DATA_GET_EVENT_RECORD function retrieves WIDECHAR data feed event record values from a data feed custom event.
...
- fields : array of WIDECHAR strings specifying what fields from the record to return

- rec : [WC_DATA_RECORD](WC_DATA_RECORD.md) structure containing the desired field values from the data feed event
