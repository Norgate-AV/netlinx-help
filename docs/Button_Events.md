...
If the event handler is specified using an array for DEV, CHANNEL, or a DEVCHAN array, [GET_LAST](GET_LAST.md) can determine which index in the array caused the event to run.
