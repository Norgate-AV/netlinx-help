...
- [(w) Cannot assign unlike types](_w_Cannot_assign_unlike_types.md)

- [(w) DEFINE_CALL is not used](_w_Define_Call_is_not_used.md)

- [(w) Integer applies to arrays only](_w_Integer_applies_to_arrays_only.md)

- [(w) LONG_WHILE within While](_w_Long_While_within_While.md)
