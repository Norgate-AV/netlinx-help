...
The goal when using M2M is to minimize the amount of traffic between masters
while providing the required functionality.

The following topics describe the various topologies that can be utilized in
[M2M](<Master-To-Master_(M2M).htm>) systems:
