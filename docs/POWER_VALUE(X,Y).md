---
title: POWER_VALUE(X,Y)
---

# POWER_VALUE

Note: Math functions are supported by NetLinx Controller firmware version 4 or
higher.
...
Where BASE and EXPONENT can be any intrinsic type (INTEGER, FLOAT,  DOUBLE,
etc).
