...
WC_DATA_RECORD structure._

The WC_DATA_RECORD structure contains information describing a
[WIDECHAR](WIDECHAR.md) data record within a WIDECHAR data feed.

WC_DATA_RECORD structure fields:

- METADATA – [WC_DATA_FIELD](WC_DATA_FIELD.md) array containing a list of
  metadata values associated with the record

- CONTENT – [WC_DATA_FIELD](WC_DATA_FIELD.md) array containing a list of data
