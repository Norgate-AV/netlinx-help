...
This function encodes a Unicode string to a character string using one of 4
formats.
...
2 - Unicode BE Encode the data as a Unicode BE (Big Endian) formatted stream.
 The constant WC_FORMAT_UNICODE_BE is defined as a value of 2 for specifying
this format.
