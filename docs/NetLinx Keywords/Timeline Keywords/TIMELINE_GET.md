...
- The timer indicates the number of milliseconds that have passed since the
  timeline started.
...
- Returns the specified timeline’s internal timer. The timer value represents
  the number of milliseconds that have passed since the timeline started.
