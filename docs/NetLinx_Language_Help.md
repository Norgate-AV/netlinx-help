...
original AMX Axcess programming language. Use the NetLinx Studio software program to create,
compile, and transfer Axcess/ NetLinx code.

!!! note

    <!-- markdownlint-disable-line -->
    Maximize the NetLinx Help window to view code examples. Since the text in the Help window
    wraps automatically based on the window size, the code in some examples may look confusing if it
    happens to wrap.

**_Last Updated: 10/25/2016_**
