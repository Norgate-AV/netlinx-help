...
The figure below shows 16 masters connected to each other such that any master is routeable to any
other master using route mode direct:

![](../../../assets/img/M2M%20-%20Clustered%20Topology.jpg)
...
-   Robust, if one master goes down communication is lost with only that master and the devices
    connected to it
